...
print("Python is an indent based programming language")
# Indentation can be using tab or spaces (usually 4 spaces), the levels of indent help to write blocks of code rather than using braces
...
print("Total sal is {0} for the emp id {1}".format(totalsal,empid) ); #add the formatted variables/arguments in the respective placeholder position
print(f" Total sal is {totalsal}  for the emp id {empid}") #add the variables in the direct positions
...
print("String & Num operations using Built in functions")
