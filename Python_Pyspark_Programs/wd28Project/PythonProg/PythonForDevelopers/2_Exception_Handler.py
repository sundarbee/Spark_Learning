...
print( " ****** Be cautious to Write in the below way to handle in one try block with one exception captured.. If any exception occured the try block will not exit out, but we can exit explicitly using exit")
...
print( " ****** Write in the below way to handle in one try block with all exceptions captured.. If any exception occured the try block will exit out")
print("preferred way")
try:
    print("Try Block WHOLE")
    num1 = 10
    #"Strongly typed" + num1
    print(num1+num1)
